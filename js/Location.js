...
maningsHeath.holes.push({number: 2, lat: 50.97198866876967, long: -0.10901180743025625, dist: 0})
courses.push(maningsHeath)

console.log(courses)


document.write("<br><br><button onClick='getLocation()'>Update Location</button>")
